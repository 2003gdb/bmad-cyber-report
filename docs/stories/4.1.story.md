...
### Data Models
- **AdminUser model**: Existing id, email, password_hash, salt, created_at structure supports admin authentication [Source: architecture/data-models.md:62-75]
...
- **AdminUser interface**: TypeScript interface with id, email, name, role, createdAt for admin session management [Source: architecture/nextjs-admin-portal-architecture.md:357-364]
